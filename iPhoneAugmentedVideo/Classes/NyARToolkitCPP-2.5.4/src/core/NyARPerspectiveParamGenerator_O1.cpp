...
{
	NyARPerspectiveParamGenerator_O1::NyARPerspectiveParamGenerator_O1(int i_local_x,int i_local_y,int i_width, int i_height)
		:NyARPerspectiveParamGenerator(i_local_x,i_local_y,i_width,i_height)
	{
	...
	bool NyARPerspectiveParamGenerator_O1::getParam(const TNyARIntPoint2d i_vertex[],double o_param[])const
	{
